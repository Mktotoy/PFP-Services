...
export default function ServiceZoneCheck() {
    ...
    return (
        <div className={styles.container}>
            <h3 className={styles.title}>📍 Testez votre éligibilité</h3>
            ...
            {result && (
                <div className={`${styles.result} ${result.covered ? styles.success : styles.error}`}>
                    {result.covered ? (
                        <>
                            <span style={{ fontSize: '1.2rem', display: 'block', marginBottom: '5px' }}>✅ Bonne nouvelle !</span>
                        ...
                        <>
                            <span style={{ fontSize: '1.2rem', display: 'block', marginBottom: '5px' }}>❌ Hors Zone</span>
