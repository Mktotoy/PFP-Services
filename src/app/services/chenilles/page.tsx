...
export const metadata: Metadata = {
    ...
    description: "Lutte contre les chenilles processionnaires en Seine-et-Marne. Enlèvement de cocons et pose d'écopièges. Intervention pour particuliers et collectivités.",
};
